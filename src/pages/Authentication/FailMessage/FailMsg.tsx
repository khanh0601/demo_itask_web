...
//import images
import icon_fail from "../../../assets/images/icon_fail.png";
                                ...
                                <div className="text-center mt-sm-5 mb-4 text-white-50">
                                    <div>
                                        <Link to="/login" className="d-inline-block auth-logo">
                                            <img src={icon_fail} alt="" height="20" />
                                        </Link>
                                    </div>
                                ...
                                <Card className="mt-4">
                                    <CardBody className="p-4 text-center">
                                        <div className="avatar-lg mx-auto mt-2">
                                            ...
                                            <img src={icon_fail} alt="" height="60" />
                                        ...
                                        <div className="mt-4 pt-2">
                                            ...
                                            <div className="mt-4">
                                                <Link to="/login" className="btn btn-danger w-100">Back to Login</Link>
                                            </div>
                                        </div>
                                    </CardBody>
                                </Card>
